...
type AssignmentConfig struct {
    ...
    GraderUID       int    `yaml:"grader_uid,omitempty"` // Used by build scripts, not by server
    GraderGID       int    `yaml:"grader_gid,omitempty"` // Used by build scripts, not by server
